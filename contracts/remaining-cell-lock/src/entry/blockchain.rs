...
impl ::core::iter::FromIterator<BytesOpt> for BytesOptVec {
    fn from_iter<T: IntoIterator<Item = BytesOpt>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<Bytes> for BytesVec {
...
impl From<[Byte; 10usize]> for ProposalShortId {
    fn from(value: [Byte; 10usize]) -> Self {
        Self::new_builder().set(value).build()
    }
}
impl ::core::convert::TryFrom<&[Byte]> for ProposalShortId {
    type Error = ::core::array::TryFromSliceError;
    fn try_from(value: &[Byte]) -> Result<Self, ::core::array::TryFromSliceError> {
        Ok(Self::new_builder()
            .set(<&[Byte; 10usize]>::try_from(value)?.clone())
            .build())
    }
}
impl From<ProposalShortId> for [Byte; 10usize] {
    #[track_caller]
...
impl From<[u8; 10usize]> for ProposalShortId {
    fn from(value: [u8; 10usize]) -> Self {
        ProposalShortIdReader::new_unchecked(&value).to_entity()
    }
}
impl ::core::convert::TryFrom<&[u8]> for ProposalShortId {
    type Error = ::core::array::TryFromSliceError;
    fn try_from(value: &[u8]) -> Result<Self, ::core::array::TryFromSliceError> {
        Ok(<[u8; 10usize]>::try_from(value)?.into())
    }
}
impl From<ProposalShortId> for [u8; 10usize] {
    #[track_caller]
    fn from(value: ProposalShortId) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
impl<'a> From<ProposalShortIdReader<'a>> for &'a [u8; 10usize] {
    #[track_caller]
    fn from(value: ProposalShortIdReader<'a>) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
impl<'a> From<&'a ProposalShortIdReader<'a>> for &'a [u8; 10usize] {
    #[track_caller]
    fn from(value: &'a ProposalShortIdReader<'a>) -> Self {
        ::core::convert::TryFrom::try_from(value.as_slice()).unwrap()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<UncleBlock> for UncleBlockVec {
    fn from_iter<T: IntoIterator<Item = UncleBlock>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<Transaction> for TransactionVec {
...
impl ::core::iter::FromIterator<ProposalShortId> for ProposalShortIdVec {
    fn from_iter<T: IntoIterator<Item = ProposalShortId>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<CellDep> for CellDepVec {
    fn from_iter<T: IntoIterator<Item = CellDep>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<CellInput> for CellInputVec {
    fn from_iter<T: IntoIterator<Item = CellInput>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<CellOutput> for CellOutputVec {
    fn from_iter<T: IntoIterator<Item = CellOutput>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
#[derive(Clone)]
...
impl ::core::iter::FromIterator<Script> for ScriptVec {
    fn from_iter<T: IntoIterator<Item = Script>>(iter: T) -> Self {
        Self::new_builder().extend(iter).build()
    }
}
